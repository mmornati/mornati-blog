...
tags:
  ...
  - customer-support
  - warranty
description: A positive experience with Jawbone support after an UP24 band failure, and how they replaced it without hassle.
---
...
After a jogging session I noticed my band was turned off. I thought it was completely discharged (even if I was sure it wasn't) and I then tried to charge it up but... when I linked the band with the official USB cable, nothing happened. It was impossible to charge it up.
I then tried to restart it up and check where was problem, and after a while pressing the (only) button the band started up, a little light blinked, night/day, two vibrations and... nothing more.
...
I gave it another try following this, but I'd already found these instructions on the net and they didn't work for me.
I think with all my tests I completely discharged my band and, due to the impossibility to charge it up, I couldn't go ahead with tests.

I then wrote a response message pointing out my problems and, without asking anything more, they offered to replace the band with a new one. Just using the band serial number the support already had information about the band size and color. I just needed to confirm the ship address to receive it with the instructions to send back my band (I sent it back after receiving the new one!)

## Resolution

I was really impressed by the incredibly efficient Jawbone support: I think it is the first support center that didn't try to avoid replacing the broken material.

I have the new Jawbone UP24 since 3 months and, right now, all is ok. All is better due to the new firmware which doubled the band's battery life! :)
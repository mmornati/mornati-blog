...
- 🌡️ **A user with a Yutaki S2 + Yutampo waterboiler** ([#52](https://github.com/mmornati/home-assistant-csnet-home/issues/52)) → Confirmed the integration works with water circuits (`elementType: 5` and `6`)
- 💨 **Someone with fan coils** reported a different speed mapping ([#127](https://github.com/mmornati/home-assistant-csnet-home/issues/127)) → We added legacy vs standard fan speed models
...
Community testers also helped catch subtle bugs: wrong temperature readings ([#137](https://github.com/mmornati/home-assistant-csnet-home/issues/137)), incorrect operation status mapping ([#122](https://github.com/mmornati/home-assistant-csnet-home/issues/122)), credential management issues ([#153](https://github.com/mmornati/home-assistant-csnet-home/issues/153)).

...
| `--read-only` | Écriture sur le système de fichiers, modification des fichiers système |
| `--tmpfs /tmp` | Limite l'espace inscriptible à 10 Mo (empêche l'épuisement du disque) |
| `--memory=512m` | Attaques DoS par épuisement mémoire |
| `--cpus=1.0` | Épuisement CPU via des boucles infinies |

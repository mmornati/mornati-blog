...
> **Mise à jour (20 août 2026).** Les correctifs `inact=65535` et bail DHCP=86400 dans cet article sont corrects et agissent au niveau du firmware. Cependant, des tests ultérieurs dans l'article bonus d'analyse approfondie ont révélé que le chipset QCA full-offload du RBR760 ne peut pas reproduire l'intervalle de balise de 31 TU de la station de base Arlo — une exigence matérielle pour la synchronisation en veille profonde des caméras. Les caméras se déconnectent de façon répétée avec l'intervalle de balise par défaut de 100 TU, rendant les correctifs de délai d'inactivité et de bail insuffisants à eux seuls. L'enquête complète est dans l'[article bonus d'analyse approfondie](/fr/analyse-approfondie-de-la-station-de-base-arlo/).

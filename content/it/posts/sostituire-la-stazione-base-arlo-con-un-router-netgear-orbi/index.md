...
> **Aggiornamento (20 agosto 2026).** Dopo aver completato la serie, ho eseguito un confronto di cattura pacchetti tra la vera stazione base Arlo e il WiFi guest dell'RBR760. I risultati completi sono nel [post bonus di approfondimento](/it/analisi-approfondita-della-stazione-base-arlo/). In sintesi: il chipset Qualcomm QCA full-offload dell'RBR760 non può replicare l'intervallo beacon di 31 TU della stazione base Arlo — un requisito fondamentale per la sincronizzazione WiFi in deep sleep delle telecamere. Le telecamere *si* connettono e registrano con l'RBR760 (la configurazione di questo post è corretta), ma si disconnettono ripetutamente con l'intervallo predefinito di 100 TU. Per il funzionamento a batteria, tenete la stazione base Arlo per il WiFi e instradate la sua Ethernet verso il server.
